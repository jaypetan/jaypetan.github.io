...
export default function Experience() {
  ...
  const experiences = [
    ...
    },
    {
      ...
      description: `Developed a user-focused web app with a strong emphasis on frontend architecture to improved satellite and ground station operations.<br/>
        Redesigned the legacy Satellite Mission Planner into a high-fidelity web app using <strong>HTML</strong>, <strong>CSS</strong>, <strong>JavaScript</strong>, and <strong>HTMX</strong>.<br/>
