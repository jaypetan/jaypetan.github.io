        ...
        <div className="flex flex-col gap-24">
            <div className="flex flex-col gap-12">
                ...
                <p className="text-gray-600">
                    The seat booking page in the original design was not
                    integrated into the application and was a seperate webpage,
                    which made booking disjointed. The booking of seats required
                    many back-and-forth taps to select the desired seats and
                    there was also a lack of visual timeline for available
                    seats.
                </p>
                <p>
                    In our redesign we aim to integrate the seat booking,
                    available timeslots and the seat map into a single, cohesive
                    native interface, making the booking process more seamless
                    and intuitive. We also added a draggable tab that users can
                    toggle to reference the seatmap when needed and a dropdown
                    for users that are more experienced. The library map,
                    seatmap and timeline are all interactive, ensuring new users
                    can easily see the location of available seats.
                </p>
            </div>
